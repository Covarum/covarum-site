    ...
    <div className="min-h-screen bg-[#0f1115] text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0f1115]/85 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
          ...
          <a
            href="#contact"
            className="rounded-2xl border border-white/15 bg-white px-4 py-2 text-sm font-medium text-[#0f1115]"
          >
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.2fr_0.8fr] lg:px-10 lg:py-28">
            <div className="relative z-10">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/72 md:text-xl">
                ...
                protect you through the detours. Because the unexpected isn’t
              ...
              <div className="mt-10 flex">
                <a
                  href="#contact"
                  className="rounded-2xl bg-white px-6 py-4 text-base font-semibold text-[#0f1115]"
                >
                  Start Your Plan
                </a>
              </div>
              ...
              <div className="mt-12 grid max-w-2xl grid-cols-2 gap-4 md:grid-cols-4">
                {pillars.map((item) => (
                  <div
                    key={item}
                    className="rounded-2xl border border-white/10 bg-[#1c2a38]/40 p-4 text-sm text-white/75"
                  >
                    {item}
                  </div>
                ))}
            ...
            <div className="relative z-10 flex items-center">
              <div className="w-full rounded-[2rem] border border-white/12 bg-[#1c2a38]/40 p-6 backdrop-blur">
                <div className="rounded-[1.75rem] border border-white/10 bg-[#243447]/60 p-6">
                  <div className="mb-5 text-sm uppercase tracking-[0.28em] text-white/50">
        ...
        <section className="mx-auto max-w-4xl px-6 py-16 text-center text-white/70">
          Most people don’t think about protection and planning until something
          forces them to. I’ve lived through enough to know it’s better to be
          prepared before that moment comes.
        </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-base leading-8 text-white/70">
                ...
                and control to the parts of their financial life that are easy
                to put off.
              </p>
              <p className="mt-4 text-base leading-8 text-white/70">
              ...
              <p className="mt-4 text-base leading-8 text-white/70">
                ...
                at least half my chauffeur duties, I’m still figuring out what
                to do with all that “extra” time… usually a great glass of wine,
                a good laugh, and the kind of company that makes everything feel
                a little lighter.
              </p>
            </div>
          </div>
        ...
        <section id="services" className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {services.map((service) => (
              <div
                key={service.title}
                className="rounded-[2rem] border border-white/10 bg-[#1c2a38]/30 p-7"
              >
        ...
        <section id="contact" className="px-6 pb-24 lg:px-10">
          <div className="mx-auto max-w-7xl rounded-[2.25rem] border border-white/10 bg-[#1c2a38]/40 p-10 text-center">
            ...
            <div className="mt-8 flex justify-center">
              <a
                href="#contact"
                className="rounded-2xl bg-white px-6 py-4 font-semibold text-[#0f1115]"
              >
                Start Your Plan
              </a>
            </div>
